...
{
    Vector3 intersectPoint = nodeIntersection(n1, n2); //交叉点，或者最近点的中点
...
void Graph::draw2D(int width, int height)
{
    ...
    QVector3D corner = QVector3D(qMin((double)0.0, (double)minBound.x()), qMin((double)0.0, (double)minBound.y()), qMin((double)0.0, (double)minBound.z()));
...
/*void Graph::getEdges( QString nodeID , QVector<Link*> &mylinks)
{
